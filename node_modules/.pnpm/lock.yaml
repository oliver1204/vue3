...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      minimist: 1.2.5
      rollup: 2.60.0
      rollup-plugin-typescript2: 0.31.0_rollup@2.60.0+typescript@4.5.2
      typescript: 4.5.2
...
packages:
  ...
  /@rollup/plugin-commonjs/21.0.1_rollup@2.60.0:
    resolution: {integrity: sha1-HlfIGuFRjk3wlU1oHGQufZRYj+4=, tarball: '@rollup/plugin-commonjs/download/@rollup/plugin-commonjs-21.0.1.tgz'}
    engines: {node: '>= 8.0.0'}
    peerDependencies:
      rollup: ^2.38.3
    dependencies:
  ...
  /@ts-type/package-dts/1.0.53:
    resolution: {integrity: sha512-P8bMcjqaUsaBbXOCxBtzT4/pvhQSHTMc91WrpErVfB52zpNRVw2evOYWMe6q3c087+wpvITB7HtppYDnQe1RwA==, tarball: '@ts-type/package-dts/download/@ts-type/package-dts-1.0.53.tgz'}
    dependencies:
      '@types/semver': 7.3.9
      ts-type: 1.2.40
  ...
  /@types/node/16.11.9:
    resolution: {integrity: sha512-MKmdASMf3LtPzwLyRrFjtFFZ48cMf8jmX5VRYrDQiJa8Ybu5VAmkqBWqKU8fdCwD8ysw4mQ9nrEHvzg6gunR7A==, tarball: '@types/node/download/@types/node-16.11.9.tgz'}
    dev: true
  ...
  /@types/semver/7.3.9:
    resolution: {integrity: sha1-FSxsIKdojDC5Z+wYQdMazlaYY/w=, tarball: '@types/semver/download/@types/semver-7.3.9.tgz'}
    dev: true

  /@yarn-tool/resolve-package/1.0.37:
    resolution: {integrity: sha1-mDfsLro6MOkUYAhYxDneJbrtrLc=, tarball: '@yarn-tool/resolve-package/download/@yarn-tool/resolve-package-1.0.37.tgz'}
    dependencies:
      '@ts-type/package-dts': 1.0.53
      pkg-dir: 5.0.0
      tslib: 2.3.1
  ...
  /path-is-network-drive/1.0.10:
    resolution: {integrity: sha1-2dcWTm0FpJ14doE6U+xcSuhqpUI=, tarball: path-is-network-drive/download/path-is-network-drive-1.0.10.tgz}
    dependencies:
      tslib: 2.3.1
    dev: true
  ...
  /path-strip-sep/1.0.7:
    resolution: {integrity: sha1-UfMf1TCZt7pZh2t7nmSSOXRBIj0=, tarball: path-strip-sep/download/path-strip-sep-1.0.7.tgz}
    dependencies:
      tslib: 2.3.1
    dev: true
  ...
  /pkg-dir/4.2.0:
    resolution: {integrity: sha1-8JkTPfft5CLoHR2ESCcO6z5CYfM=, tarball: pkg-dir/download/pkg-dir-4.2.0.tgz}
    engines: {node: '>=8'}
    dependencies:
      find-up: 4.1.0
    dev: true
  ...
  /pkg-dir/5.0.0:
    resolution: {integrity: sha1-oC1q6+a6EzqSj3Suwguv3+a452A=, tarball: pkg-dir/download/pkg-dir-5.0.0.tgz}
    engines: {node: '>=10'}
    dependencies:
      find-up: 5.0.0
    dev: true
  ...
  /rollup-plugin-typescript2/0.31.0_rollup@2.60.0+typescript@4.5.2:
    resolution: {integrity: sha512-lA0KSTaaekrxcyd3MlUzD1QWt6IJEUBMV1KAKMiAm9UrWrmh4xAnANaOWGISEB6lNyVsPhkITmRCbZYVxpp1KA==, tarball: rollup-plugin-typescript2/download/rollup-plugin-typescript2-0.31.0.tgz}
    peerDependencies:
      rollup: '>=1.26.3'
      typescript: '>=2.4.0'
    dependencies:
  ...
  /rollup/2.60.0:
    resolution: {integrity: sha512-cHdv9GWd58v58rdseC8e8XIaPUo8a9cgZpnCMMDGZFDZKEODOiPPEQFXLriWr/TjXzhPPmG5bkAztPsOARIcGQ==, tarball: rollup/download/rollup-2.60.0.tgz}
    engines: {node: '>=10.0.0'}
    hasBin: true
    optionalDependencies:
      fsevents: 2.3.2
  ...
  /ts-type/1.2.40:
    resolution: {integrity: sha1-2zzrlSgVZ/5yWRuakESI6FxbdP4=, tarball: ts-type/download/ts-type-1.2.40.tgz}
    peerDependencies:
      '@types/bluebird': '*'
      '@types/node': '*'
      ts-toolbelt: ^8.0.7
  ...
  /tslib/2.2.0:
    resolution: {integrity: sha1-+yxHWXfjXiQTEe3iaTzuHsZpj1w=, tarball: tslib/download/tslib-2.2.0.tgz}
    dev: true
  ...
  /typedarray-dts/1.0.0:
    resolution: {integrity: sha1-neyYEThtv7qWTClcJgbPmmuYLQY=, tarball: typedarray-dts/download/typedarray-dts-1.0.0.tgz}
    dev: true
  ...
  /upath2/3.1.10:
    resolution: {integrity: sha1-vT3nZSOUYQLQbQDUs3I+Om/3U/Y=, tarball: upath2/download/upath2-3.1.10.tgz}
    peerDependencies:
      '@types/node': '*'
    dependencies:
      lodash: 4.17.21
